...
const optionalDateOnly = (field, label) =>
  body(field)
    .optional()
    .trim()
    .matches(/^\d{4}-\d{2}-\d{2}$/)
...
const listSprintsValidation = [projectIdParam];
...
const deleteSprintValidation = [projectIdParam, sprintIdParam];
